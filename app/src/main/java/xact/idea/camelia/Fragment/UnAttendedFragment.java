...
public class UnAttendedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         view= inflater.inflate(R.layout.fragment_un_attended, container, false);
    ...
    public static  void display() {
        compositeDisposable.add(Common.memberMyselfRepository.getReferMembersFor().observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io()).subscribe(new Consumer<List<VisitMyself>>() {
            @Override
