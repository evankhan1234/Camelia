...
//        });
    ...
    private void updateView(String language) {
        ...
        edit_diabetis_month.setHint(resources.getString(R.string.year));
        edit_yes_blood.setHint(resources.getString(R.string.year));
        edit_yes_heart_attack.setHint(resources.getString(R.string.year));
        edit_yes_heart_brain_stroke.setHint(resources.getString(R.string.year));
        edit_yes_lung_disease.setHint(resources.getString(R.string.year));
        edit_yes_ashma.setHint(resources.getString(R.string.year));
        edit_yes_kidney_disease.setHint(resources.getString(R.string.year));
        edit_yes_cancer.setHint(resources.getString(R.string.year));
        edit_yes_mental_disorder.setHint(resources.getString(R.string.year));
